...
| T04 | Reach live accidentally                                                  | Real financial effect                             | Global AND tenant switches, live credentials absent, `livemode` rejection, and no direct Phase-0 route/client/switch                                                                                                                                     | Startup/config tests, pilot-surface absence test and a live-context rejection test                                            | Future activation needs a new review                                                 |
